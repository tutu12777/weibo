...
//		NSLog(@"%@",[NSString stringWithFormat:@"%s=%d==%@=%@",__FUNCTION__,[dict count], key, [[dict objectForKey:key] URLEncodedString]]);
...
+ (NSString *)serializeURL:(NSString *)baseURL params:(NSDictionary *)params httpMethod:(NSString *)httpMethod
{
	...
	NSLog(@"%@",[NSString stringWithFormat:@"%@%@%@===%d===%@", baseURL, queryPrefix, query,[params count], [params objectForKey:@"since_id"]]);
