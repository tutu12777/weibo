...
#define kWBSDKDemoAppKey @"512604036"
#define kWBSDKDemoAppSecret @"2fed61aa3522cd94b4b0655ac07a0ed8"
...
- (void)presentTimelineViewController:(BOOL)animated
{
    EntryForDataList *controller = [[EntryForDataList alloc] initWithAppKey:kWBSDKDemoAppKey appSecret:kWBSDKDemoAppSecret];
//    EntryForDataList *controller = [EntryForDataList alloc]
